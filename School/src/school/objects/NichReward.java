...
public class NichReward extends GameObject{
	...
	Handler handler;
	public NichReward(float x, float y, ID id, Handler handler) {
		super(x, y, id);
	...
	public void render(Graphics g) {
		g.drawImage(tex.artifact[11], (int)x,  (int)y, 32, 32, null);
	}
