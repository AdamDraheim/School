...
public class RebeccaReward extends GameObject{
	...
	Handler handler;
	public RebeccaReward(float x, float y, ID id, Handler handler) {
		super(x, y, id);
	...
	public void render(Graphics g) {
		g.drawImage(tex.artifact[13], (int)x,  (int)y, 32, 32, null);
	}
